...
contract TokenManagerRaiser is ITokenControllerX, IForwarder, AragonApp {
    ...
    // Note that we COMPLETELY trust this MiniMeTokenRaiser to not be malicious for proper operation of this contract
    MiniMeTokenRaiser public token;
    ...
    * @param _token MiniMeTokenRaiser address for the managed token (Token Manager instance must be already set as the token controller)
    * @param _transferable whether the token can be transferred by holders
    * @param _maxAccountTokens Maximum amount of tokens an account can have (0 for infinite tokens)
    */
    function initialize(
        MiniMeTokenRaiser _token,
        bool _transferable,
