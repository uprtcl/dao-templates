...
contract BaseTemplateRaiser is APMNamehash, IsContract {
    ...
    */
    ...
    function _installVotingApp(Kernel _dao, MiniMeTokenRaiser _token, uint64[3] memory _votingSettings) internal returns (Voting) {
    ...
    function _installSurveyApp(Kernel _dao, MiniMeTokenRaiser _token, uint64 _minParticipationPct, uint64 _surveyTime) internal returns (Survey) {
